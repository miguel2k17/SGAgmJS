...
calls to this DAO, otherwise a new Connection will be allocated for each operation.
	 ...
	 */
	protected final String SQL_SELECT = "SELECT id_usuario, id_persona, username, password FROM " + 
                getTableName() + "";
	...
	protected final String SQL_UPDATE = "UPDATE " + getTableName() + 
                " SET id_usuario = ?, id_persona = ?, username = ?, password = ? WHERE id_usuario = ?";
